using AmaniRobot.Infrastructure.HealthChecks;
using AmaniRobot.WebApi.ApiClient;
using AmaniRobot.WebApi.Extensions;
using AmaniRobot.WebApi.Extensions.FeatureFlags;
...
services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        Version = "v1",
        Title = "AmaniRobot",
        Description = "The AmaniRobot service. The API contains OpenAPI documentation. This useful when used with LangChain tools and agents.",
    ...
    c.AddServer(new OpenApiServer() { Url = "http://amanirobot-service", Description = "Docker version to use within docker compose" });
    c.AddServer(new OpenApiServer() { Url = "https://amanirobot.azurewebsites.net", Description = "Deploy on Azure" });
